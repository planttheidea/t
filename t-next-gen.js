...
//                        return this.map(callback)[0];
    ...
    t.extend({
        ...
        supports:{
            ...
            oga:internal.supports.html5.mediaType('audio','ogg'),
            ogv:internal.supports.html5.mediaType('video','ogg'),
            opacity:internal.supports.css3.property(['webkitOpacity','MozOpacity','opacity']),
            pageOffset:(!t.is.undefined(pageYOffset)),
            pageXOffset:(!t.is.undefined(pageXOffset)),
            pageYOffset:(!t.is.undefined(pageYOffset)),
            pattern:internal.supports.html5.attribute('pattern'),
            placeholder:internal.supports.html5.attribute('placeholder'),
            postMessage:!!(window.postMessage),
            pseudoActive:internal.supports.css3.selector('::after'),
