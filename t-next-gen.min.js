...
"calc(1% - 1px)"),cssColumn:e.supports.css3.property(["columnCount","webkitColumnCount","MozColumnCount"]),cssReflection:e.supports.css3.property(["boxReflect","WebkitBoxRefect"]),customEvent:!!h.CustomEvent,geolocation:!!("geolocation"in navigator),getBoundingClientRect:!!(f.documentElement||f.body).getBoundingClientRect,getElementsByClassName:!!f.getElementsByClassName,flexbox:e.supports.css3.value("display","flex"),history:!(!h.history||!h.history.popstate),hsla:e.supports.css3.value("color","hsla(0,0%,0%,0)"),
inputDate:e.supports.html5.input("date"),inputDateTime:e.supports.html5.input("datetime"),inputDateTimeLocal:e.supports.html5.input("datetime-local"),inputEmail:e.supports.html5.input("email"),inputMonth:e.supports.html5.input("month"),inputNumber:e.supports.html5.input("number"),inputRange:e.supports.html5.input("range"),inputSearch:e.supports.html5.input("search"),inputTel:e.supports.html5.input("tel"),inputTime:e.supports.html5.input("time"),inputUrl:e.supports.html5.input("url"),inputWeek:e.supports.html5.input("week"),
list:e.supports.html5.attribute("list"),json:!(!JSON||!d.is["function"](JSON.parse)),localStorage:function(){try{return h.localStorage.setItem("test","test"),h.localStorage.removeItem("test"),!0}catch(a){return!1}}(),linearGradient:function(){try{for(var a=["linear-gradient","-webkit-linear-gradient","-moz-linear-gradient","-o-linear-gradient"],b=a.length;b--;)if(e.supports.css3.value("background",a[b]+"(-45deg,rgba(0,0,0,0) 0%,rgba(0,0,0,1) 100%)"))return!0;return e.supports.css3.value("background",
"-webkit-gradient(linear,left top,left bottom,from(rgba(0,0,0,0)),to(rgba(0,0,0,1)))")}catch(c){return!1}}(),max:e.supports.html5.attribute("max"),mediaQueries:function(){var a=f.createElement("div"),b=f.createElement("style"),c=f.body,d=!1;a.id="MediaTest";c.appendChild(a);b.textContent="@media screen and (min-width:1px){#MediaTest{position:absolute;}}";c.appendChild(b);h.getComputedStyle&&"absolute"==h.getComputedStyle(a).position&&(d=!0);c.removeChild(a);c.removeChild(b);return d}(),min:e.supports.html5.attribute("min"),
mp3:e.supports.html5.mediaType("audio","mp3"),mp4:e.supports.html5.mediaType("audio","mp4")&&e.supports.html5.mediaType("video","mp4"),mp4Audio:e.supports.html5.mediaType("audio","mp4"),mp4Video:e.supports.html5.mediaType("video","mp4"),multiple:e.supports.html5.attribute("multiple"),oga:e.supports.html5.mediaType("audio","ogg"),ogv:e.supports.html5.mediaType("video","ogg"),opacity:e.supports.css3.property(["webkitOpacity","MozOpacity","opacity"]),pageOffset:!d.is.undefined(pageYOffset),pageXOffset:!d.is.undefined(pageXOffset),
pageYOffset:!d.is.undefined(pageYOffset),pattern:e.supports.html5.attribute("pattern"),placeholder:e.supports.html5.attribute("placeholder"),postMessage:!!h.postMessage,pseudoActive:e.supports.css3.selector("::after"),pseudoBefore:e.supports.css3.selector("::before"),pseudoFirstLetter:e.supports.css3.selector("::first-letter"),pseudoFirstLine:e.supports.css3.selector("::first-line"),radialGradient:function(){try{for(var a=["radial-gradient","-webkit-radial-gradient","-moz-radial-gradient","-o-radial-gradient"],
...
step:e.supports.html5.attribute("step"),smil:!!(f.createElementNS&&-1<f.createElementNS("http://www.w3.org/2000/svg","animateMotion").toString().indexOf("SVG")),svg:!(!f.createElementNS||!f.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect),textShadow:e.supports.css3.property(["textShadow"]),transform:e.supports.css3.property(["transform","WebkitTransform","MozTransform","msTransform","OTransform"]),transform3d:function(){try{for(var a=["transform","WebkitTransform","MozTransform",
...
!0}catch(c){return!1}}(),webm:e.supports.html5.mediaType("video","webm"),webSocket:!(!h.WebSocket||!h.WebSocket.prototype.send),webSQL:!!h.openDatabase},unsubscribe:function(){e.pubsub.unsubscribe.apply(this,arguments)}});d.p.extend({addClass:function(){return d.supports.classList?function(a){return this.each(function(b){b.classList.add(a)})}:function(a){return this.each(function(b){b.className+=" "+a})}}(),append:function(a){if(d.is.domNode(a))return this.each(function(b){b.appendChild(a)});if(d.is.t(a))return this.each(function(b){a.each(function(a,
d){b.appendChild(a)})})},after:function(a){return this.each(function(b){b.insertAdjacentHTML("afterend",a)})},attribute:function(a,b){if(d.is.object(a))return this.each(function(b){for(var g in a)d.is["boolean"](a[g])?b[g]=a[g]:b.setAttribute(g,a[g])});if(d.is.string(a))return d.is.undefined(b)?this.mapOne(function(b){switch(a){case "readonly":case "disabled":case "autofocus":case "required":case "novalidate":case "multiple":return b.getAttribute(a)||!0;default:return b.getAttribute(a)}}):d.is["boolean"](b)?
this.each(function(c){c[a]=b}):this.each(function(c){c.setAttribute(a,b)});if(d.is.array(a))return self.mapOne(function(b){for(var d={},e=0,f=a.length;e<f;e++){var h;switch(a[e]){case "readonly":case "disabled":case "autofocus":case "required":case "novalidate":case "multiple":h=b.getAttribute(a[e])||!0;break;default:h=b.getAttribute(a[e])}d[a[e]]=h}return d});if(d.is.undefined(a))return this.mapOne(function(a){a=a.attributes;for(var b={},d=0,e=a.length;d<e;d++){var f;switch(a[d].nodeName){case "readonly":case "disabled":case "autofocus":case "required":case "novalidate":case "multiple":f=
a[d].nodeValue||!0;break;default:f=a[d].nodeValue}b[a[d].nodeName]=f}return b})},before:function(a){return this.each(function(b){b.insertAdjacentHTML("beforebegin",a)})},children:function(){var a=[];this.each(function(b){for(var c=0,d=b.children.length;c<d;c--)8!==b.children[c].nodeType&&(a[a.length]=b.children[c])});return d(a,this.original)},contains:function(a){var b=f.createElement("div");return d.is.domNode(b.firstChild)?this.mapOne(function(b){return b!==a&&b.contains(a)}):this.mapOne(function(b){return null!==
b.querySelector(a)})},empty:function(){return this.each(function(a){a.innerHTML=""})},element:function(a){return this[a]},filter:function(a){var b=[];d.is.string(a)?this.each(function(a){for(var d=f.querySelectorAll(selector),e=d.length;e--;)a===d[e]&&(b[b.length]=d[e])}):d.is["function"](a)?this.each(function(c){c=f.querySelectorAll(selector);for(var d=c.length;d--;)a(c[d])&&(b[b.length]=c[d])}):this.each(function(a){b[b.length]=a});return d(b,this.original)},find:function(a){var b=a.split(" "),
c=[];-1!==b[b.length-1].indexOf("#")?this.each(function(b){b=b.querySelector(a);d.is["null"](elChildren)||!b||c.length||(c[c.length]=b)}):this.each(function(b){b=b.querySelectorAll(a);if(!d.is["null"](b)&&b.length)for(var e=0,f=b.length;e<f;e++)c[c.length]=b[e]});return d(c,this.original)},hasClass:function(){return d.supports.classList?function(a){return this.mapOne(function(b){return b.classList.contains(a)})}:function(a){return this.mapOne(function(b){return(new RegExp("(^| )"+a+"( |$)","gi")).test(b.className)})}}(),
html:function(a){return d.is.undefined(a)?this.mapOne(function(a){return a.innerHTML}):this.each(function(b){b.innerHTML=a})},index:function(a){return d(this[a],this.original)},next:function(a){return d.is.undefined(a)?d(this.mapOne(function(a){return a.nextElementSibling}),this.original):d(this.mapOne(function(b){if(e.matchesSelector(b,a))return b.nextElementSibling}),this.original)},on:function(a,b){return d.is.object(a)?this.each(function(c){d.is.object(this.events)||(this.events={});for(var e in a)this.events[e]=
a[e],b?c.addEventListener(e,function(d){var f=c.querySelectorAll(b);if(f.length)for(var h=f.length;h--;)f[h]===d.target&&a[e].call()},!1):c.addEventListener(e,a[e],!1)}):this},off:function(a){return d.is.array(a)?this.each(function(b){for(var c=a.length;c--;)this.events[a[c]]&&b.removeEventListener(key,this.events[a[c]],!1)}):d.is.string(a)?this.each(function(b){this.events[a]&&(b.removeEventListener(a,this.events[a],!1),delete this.events[a],console.log(this.events))}):this},prepend:function(a){if(d.is.domNode(a))return this.each(function(b){b.insertBefore(a,
b.firstChild)});if(d.is.t(a))return this.each(function(b){a.each(function(a,d){b.insertBefore(a,b.firstChild)})})},previous:function(a){return d.is.undefined(a)?d(this.mapOne(function(a){return a.previousElementSibling}),this.original):d(this.mapOne(function(b){if(e.matchesSelector(b,a))return b.previousElementSibling}),this.original)},remove:function(){for(var a=this.length;a--;){var b=this[a];b.parentNode.removeChild(b);delete this[a]}this.length=0;return this},removeClass:function(){return d.supports.classList?
function(a){return this.each(function(b){b.classList.remove(a)})}:function(a){return this.each(function(b,c){b.className=b.className.replace(new RegExp("(^|\\b)"+a.split(" ").join("|")+"(\\b|$)","gi")," ")})}}(),revert:function(){return d(this.original,this.original)},text:function(a){return d.is.undefined(a)?this.mapOne(function(a){return a.textContent}):this.each(function(b){b.textContent=a})},value:function(a){return d.is.undefined(a)?this.mapOne(function(a){return a.value}):this.each(function(b){b.value=
a})}});h.t=d})(window,document);
